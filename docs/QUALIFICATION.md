...
- **Locally / hermetically qualified** — proven by the in-process test suite with
  ...
  closed, drift is detected, and no test opens a network socket, a `state.db`, or
  a subprocess.
